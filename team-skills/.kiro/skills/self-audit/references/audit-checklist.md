...
- [ ] **Transformation correctness** — Manually verify 2–3 rows through the transformation logic. Does the math check out?
...
- **1–2 FIX items** — Fix and note briefly. Delivery proceeds normally.
