...
description: LATIDO Friday Handoff — Steering Wheel Protocol v1.1, Cowork → Symbios Chat. Closes the work week, writes CF Active entry tagged for Browser Symbios. First auto-firing carrier-shedding mechanism — closes GAP-FH1.
---
