---
name: council
description: Show the latest APEX MASTERS Council verdicts — ranked GO / NEAR-MISS / PASS with asymmetry score, R:R, all 7 voice votes, and thesis. Trigger on "/council", "council", "council verdicts", "what does the council say", "show council", "council tiers", "GO NEAR-MISS", "what's the council reading", or any request to see the Council's current per-ticker opinion without opening the dashboard.
---
...
Each GO/NEAR-MISS row shows: the 0–100 asymmetry score, action, R:R, entry, the Gideon-override flag, all 7 voice votes (Elliott / Hannah / Marco / Theodore / Iris / Felix / Gideon), and the one-line thesis.
